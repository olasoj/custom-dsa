 ...
 * <p>
 * Solution:
 * "Patience Sort" is a general purpose sorting algorithm that in the process of sorting also finds the longest increasing subsequence.
...
public class LongestIncreasingSubsequence {
    ...
    int binarySearchHostPileIdx(List<List<Card>> piles, int i) {
        ...
        while (l <= r) {
            ...
            if (i > c.i) l = m + 1; // ignore left half
            if (i == c.i) return m; // exact match
            if (i < c.i) r = m - 1; // ignore right half
        }
